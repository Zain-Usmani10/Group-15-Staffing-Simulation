...
#include "customer.h" // This brings in <string> and <nlohmann/json.hpp> automatically
...
int main() {
    ...
    while (run) {
        cout << "\nTo enter a customer, press 1. Otherwise, press any key to exit and recieve JSON file: ";
        cin >> mode;
        cin.ignore(1000, '\n');
